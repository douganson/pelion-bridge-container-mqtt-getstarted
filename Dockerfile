...
RUN apt-get -y install openjdk-8-jre vim locales openssh-server supervisor dnsutils unzip zip ntp mosquitto npm sudo git curl dirmngr apt-transport-https lsb-release ca-certificates build-essential
